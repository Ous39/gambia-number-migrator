...
export default function Dashboard() {
  ...
  return <div className="dashboardPage">
    ...
    <section className="dashboardColumns">
      ...
      <article className="panel workflowPanel"><div className="panelHeading"><div><span className="eyebrow">RELEASE WORKFLOW</span><h2>Production checklist</h2></div><Activity size={24}/></div><Workflow n="1" title="Verify operator rules" done={Number(data?.activeRules)>0}/><Workflow n="2" title="Test official number samples" done={Number(data?.activeRules)===12}/><Workflow n="3" title="Publish and sync mobile rules" done={Boolean(data?.lastRulesPublishDate)}/><Workflow n="4" title="Activate live payment credentials" done={false}/></article>
    </section>
